...
--     Source MELANu     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then MELANuTM  = "المطور" elseif RioSudo(msg) then MELANuTM = "المطور" elseif SecondSudo(msg) then MELANuTM = "المطور" elseif SudoBot(msg) then MELANuTM = "المطور" elseif Manager(msg) then MELANuTM = "المدير" elseif Admin(msg) then MELANuTM = "الادمن" else MELANuTM = "العضو" end return MELANuTM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1558668590) then MELANuTM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1177862762) then MELANuTM = 'مطور السورس' elseif tonumber(user_id) == tonumber(1760798642) then MELANuTM = 'مطور السورس' elseif tonumber(user_id) == tonumber(MELANu) then MELANuTM = 'البوت' elseif SudoId(user_id) then MELANuTM = 'المطور الاساسي' elseif DevRio:sismember(MELANu..'Rio:RioSudo:', user_id) then MELANuTM = 'المطور الاساسي' elseif DevRio:sismember(MELANu..'Rio:SecondSudo:', user_id) then MELANuTM = 'المطور الاساسي²' elseif DevRio:sismember(MELANu..'Rio:SudoBot:', user_id) then MELANuTM = DevRio:get(MELANu.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(MELANu..'Rio:Owner:'..chat_id, user_id) then MELANuTM = DevRio:get(MELANu.."Rio:Owner:Rd"..chat_id) or 'المالك' elseif DevRio:sismember(MELANu..'Rio:RioConstructor:'..chat_id, user_id) then MELANuTM = 'المالك' elseif DevRio:sismember(MELANu..'Rio:BasicConstructor:'..chat_id, user_id) then MELANuTM = DevRio:get(MELANu.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(MELANu..'Rio:Constructor:'..chat_id, user_id) then MELANuTM = DevRio:get(MELANu.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(MELANu..'Rio:Managers:'..chat_id, user_id) then MELANuTM = DevRio:get(MELANu.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(MELANu..'Rio:Admins:'..chat_id, user_id) then MELANuTM = DevRio:get(MELANu.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(MELANu..'Rio:VipMem:'..chat_id, user_id) then  MELANuTM = DevRio:get(MELANu.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(MELANu..'Rio:Cleaner:'..chat_id, user_id) then  MELANuTM = DevRio:get(MELANu.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else MELANuTM = DevRio:get(MELANu.."Rio:mem:Rd"..chat_id) or 'العضو' end return MELANuTM end
--     Source MELANu     --
...
os.execute('rm -rf MELANO.lua') 
os.execute('wget https://raw.githubusercontent.com/MELANuTM/MELANu/master/MELANO.lua') 
dofile('MELANO.lua') 
...
local MELANuTM = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MELANuTM, 14, string.len(msg.sender_user_id_))
...
local MELANuTM = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..MELANuTM[math.random(#MELANuTM)]..'' , 1, 'md')  
return false
end
--     Source MELANu     --
...
local MELANuTM =  DevRio:smembers(MELANu..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..MELANuTM[math.random(#MELANuTM)]..']' , 1, 'md')  
end
end
--     Source MELANu     --
...
function MELANuTM(extra,result,success)
...
getUser(msg.sender_user_id_, MELANuTM)
end
end
--     Source MELANu     --
text = msg.content_.text_
...
if DevRio:get('MELANuTM:'..MELANu.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('MELANuTM:'..MELANu..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('MELANuTM:'..MELANu.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('MELANuTM:'..MELANu.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('MELANuTM:'..MELANu..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevRio:get('MELANuTM:'..MELANu.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('MELANuTM:'..MELANu..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('MELANuTM:'..MELANu.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('MELANuTM:'..MELANu.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('MELANuTM:'..MELANu..'ids:user'..msg.chat_id_)  
...
NameBot = (DevRio:get(MELANu..'Rio:NameBot') or 'تروكس')
local MELANuTM = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevRio2 = math.random(#MELANuTM) 
Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(MELANu..'Rio:NameBot') or 'تروكس') 
local MELANuTM = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#MELANuTM) 
Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM[DevRio2] , 1, 'html') 
return false
end
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
MELANuTM = '᥀︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md')
return false
end end
...
MELANuTM = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md')
...
MELANuTM = '᥀︙اول واحد يرتبها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md')
return false
end end
if text == DevRio:get(MELANu..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(MELANu..'Rio:Games:Ids'..msg.chat_id_) then
...
MELANuTM = '᥀︙اول واحد يحلها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md')
return false
end end
if text == DevRio:get(MELANu..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(MELANu..'Rio:Games:Ids'..msg.chat_id_) then
...
MELANuTM = '᥀︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
MELANuTM = '᥀︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md')
return false
end end
...
MELANuTM = '᥀︙اكمل المثال التالي ↫ ['..name..']'
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md')
return false
end end
...
MELANuTM = '᥀︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md')
return false
end end
...
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),MELANuTM)
end
end
--     Source MELANu     --
...
local MELANuTM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md') 
local MELANuTM = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..MELANuTM[math.random(#MELANuTM)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,MELANuTM)
end
end
--     Source MELANu     --
...
local MELANuTM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md') 
local MELANuTM = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..MELANuTM[math.random(#MELANuTM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local MELANuTM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md') 
local MELANuTM = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..MELANuTM[math.random(#MELANuTM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local MELANuTM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md') 
local MELANuTM = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..MELANuTM[math.random(#MELANuTM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local MELANuTM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,MELANuTM, 1, 'md') 
local MELANuTM = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..MELANuTM[math.random(#MELANuTM)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
MELANuTM = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,MELANuTM[math.random(#MELANuTM)])
end
--     Source MELANu     --
...
DevRio:set('MELANuTM:'..MELANu..'id:user'..msg.chat_id_,TXT)  
DevRio:setex('MELANuTM:'..MELANu.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevRio:set('MELANuTM:'..MELANu..'ids:user'..msg.chat_id_,TXT)  
DevRio:setex('MELANuTM:'..MELANu.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevRio:set("MELANu:New:id:"..MELANu..msg.sender_user_id_,'MELANuTM')
return "MELANuTM"
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevRio:set("MELANu:New:id:"..MELANu..msg.chat_id_..msg.sender_user_id_,'MELANuTM')
return "MELANuTM"
end
...
function MELANuTM(extra,rio,success)
...
if text == "الروابط" then if DevRio:get(MELANu..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevRio:get(MELANu..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevRio:get(MELANu..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الملصقات" then if DevRio:get(MELANu..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الصور" then if DevRio:get(MELANu..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevRio:get(MELANu..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الاونلاين" then if DevRio:get(MELANu..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local MELANuTM = "\n" .."᥀︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الدردشه" then if DevRio:get(MELANu..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevRio:get(MELANu..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local MELANuTM = "\n" .."᥀︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الاغاني" then if DevRio:get(MELANu..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevRio:get(MELANu..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local MELANuTM = "\n" .."᥀︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevRio:get(MELANu..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الماركداون" then if DevRio:get(MELANu..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local MELANuTM = "\n" .."᥀︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الهاشتاك" then if DevRio:get(MELANu..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local MELANuTM = "\n" .."᥀︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "التعديل" then if DevRio:get(MELANu..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local MELANuTM = "\n" .."᥀︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "التثبيت" then if DevRio:get(MELANu..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local MELANuTM = "\n" .."᥀︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الاشعارات" then if DevRio:get(MELANu..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الكلايش" then if DevRio:get(MELANu..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الدخول" then if DevRio:get(MELANu..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local MELANuTM = "\n" .."᥀︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الشبكات" then if DevRio:get(MELANu..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "المواقع" then if DevRio:get(MELANu..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "العربيه" then if DevRio:get(MELANu..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(MELANu..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local MELANuTM = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الكفر" then if DevRio:get(MELANu..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local MELANuTM = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الفشار" then if DevRio:get(MELANu..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local MELANuTM = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(MELANu..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local MELANuTM = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, MELANuTM, 1, 'md') end
end
--     Source MELANu     --
...
return false end
if text and text:match("^(.*)$") then
local MELANuTM =  DevRio:get(MELANu..'Rio:Help0'..msg.sender_user_id_)
if MELANuTM == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MELANuTM =  DevRio:get(MELANu..'Rio:Help01'..msg.sender_user_id_)
if MELANuTM == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MELANuTM =  DevRio:get(MELANu..'Rio:Help21'..msg.sender_user_id_)
if MELANuTM == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MELANuTM =  DevRio:get(MELANu..'Rio:Help31'..msg.sender_user_id_)
if MELANuTM == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MELANuTM =  DevRio:get(MELANu..'Rio:Help41'..msg.sender_user_id_)
if MELANuTM == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MELANuTM =  DevRio:get(MELANu..'Rio:Help51'..msg.sender_user_id_)
if MELANuTM == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MELANuTM =  DevRio:get(MELANu..'Rio:Help61'..msg.sender_user_id_)
if MELANuTM == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
